  ...
  return (
    <div>
      ...
      <div style={{ maxWidth: "900px", margin: "4rem auto", padding: "0 2rem" }}>
        <h1 style={{ fontSize: "2rem", marginBottom: "2rem" }}>Convert PDF to HTML</h1>
        ...
        {htmlResult && (
          <div style={{ marginTop: "2rem", backgroundColor: "#f9f9f9", padding: "1rem", borderRadius: "5px" }}>
            <strong>Extracted HTML:</strong>
            <div
              style={{ marginTop: "1rem", fontFamily: "monospace", whiteSpace: "pre-wrap", overflowX: "auto" }}
