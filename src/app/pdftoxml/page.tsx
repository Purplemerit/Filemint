...
export default function PdfToXmlPage() {
  ...
  const instructionData = toolData["pdf-to-xml"];
  ...
  const handleConvert = async () => {
    ...
    try {
      const res = await fetch("/api/pdftoxml", { method: "POST", body: formData });
      if (!res.ok) {
        ...
        <div style={{ flex: 1, maxWidth: "900px", margin: "0 auto" }}>
            ...
            {!file ? (
              ...
              <div style={{
                ...
                <p style={{ color: "#666", textAlign: "center", maxWidth: "400px" }}>
                  Your PDF has been converted to XML. Download your file below.
                </p>
          ...
          <div style={{ marginTop: "3rem", fontFamily: 'Georgia, "Times New Roman", serif' }}>
            <p style={{ marginBottom: "1rem", fontSize: "0.95rem", color: "#555" }}>
              Convert your PDF files to XML format for data processing and integration with our seamless online tool.
            </p>
            <ul style={{ listStyleType: "none", fontSize: "0.95rem", padding: 0, margin: 0 }}>
              {[
                "Perfect for data extraction and automation",
