...
export default function PdfToMarkdownPage() {
  ...
  const instructionData = toolData["pdf-to-markdown"];
  ...
  const handleConvert = async () => {
    ...
    try {
      const res = await fetch("/api/pdftomarkdown", {
        method: "POST",
        body: formData,
      });
        ...
        <div style={{ flex: 1, maxWidth: "900px", margin: "0 auto" }}>
            ...
            {!file ? (
              ...
              <div style={{
                ...
                <p style={{ color: "#666", textAlign: "center", maxWidth: "400px" }}>
                  Your PDF has been converted to Markdown. Download your file below.
                </p>
          ...
          <div style={{ marginTop: "3rem", fontFamily: 'Georgia, "Times New Roman", serif' }}>
            <p style={{ marginBottom: "1rem", fontSize: "0.95rem", color: "#555" }}>
              Convert your PDF files to Markdown format for easy editing and version control with our seamless online tool.
            </p>
