...
export default function ExcelToPdfPage() {
  ...
  const handleDrop = (e: React.DragEvent<HTMLDivElement>) => {
    ...
    if (droppedFiles.length < e.dataTransfer.files.length) {
      setError("Only XLS/XLSX files are supported.");
    }
      ...
      <div style={{ maxWidth: "900px", margin: "4rem auto", padding: "0 2rem" }}>
        ...
        >
          ...
          <p style={{ marginTop: "1rem", marginBottom: "1rem" }}>
            Drag and drop a XLS/XLSX file here
          </p>
          <label
            htmlFor="fileInput"
            style={{
        ...
        <div style={{ marginTop: "3rem" }}>
          <p style={{ marginBottom: "1rem", fontSize: "0.95rem" }}>
            Easily convert XLS, XLSX, and other Excel spreadsheets into high-quality PDFs.
          </p>
        </div>
        ...
        >
          ...
          <p style={{ marginTop: "0.5rem" }}>
            Your Excel files are encrypted during upload and automatically deleted after 2 hours. No tracking. No storage. Full privacy.
          </p>
        </div>
      </div>
    </div>
