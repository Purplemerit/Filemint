...
export default function ExcelToPdfPage() {
  ...
  const instructionData = toolData["excel-to-pdf"];
  ...
  const handleConvert = async () => {
    if (files.length === 0) {
      setError("Please upload at least one XLS/XLSX file.");
      return;
    }
    if (files.length > 1) {
      setError("Only one XLS/XLSX file can be converted at a time.");
      return;
    }
  ...
  const handleUrlSubmit = async () => {
    ...
    try {
      ...
      const fileName = urlInput.split("/").pop() || "downloaded.xlsx";
  ...
  const handleFromClipboard = async () => {
    try {
      ...
      for (const item of clipboardItems) {
        for (const type of item.types) {
          if (type.includes("spreadsheet") || type.includes("excel")) {
            ...
            const file = new File([blob], "clipboard.xlsx", { type });
            setFiles([file]);
            setError(null);
            break;
          }
      ...
      alert("No Excel file found in clipboard or clipboard access denied");
    }
    setIsDropdownOpen(false);
  };
    ...
    <div>
        ...
        <div style={{ flex: 1, maxWidth: "900px", margin: "0 auto" }}>
            ...
            {isConverted ? (
              ...
              <div style={{
                ...
                <p style={{ color: "#666", textAlign: "center", maxWidth: "400px" }}>
                  Your Excel file has been converted to PDF. Download your file below.
                </p>
          ...
          <div style={{ marginTop: "3rem", fontFamily: 'Georgia, "Times New Roman", serif' }}>
            <p style={{ marginBottom: "1rem", fontSize: "0.95rem", color: "#555" }}>
              Easily convert your Excel spreadsheets to PDF format with our seamless online tool.
            </p>
      ...
      {showUrlModal && (
        ...
        >
          ...
          >
            <h3 style={{ marginBottom: "1rem" }}>Paste Excel URL</h3>
            <input
              type="url"
              value={urlInput}
