...
export default function PdfSummarizer() {
  ...
  const instructionData = toolData["pdf-summarizer"] || toolData["merge-pdf"];
  ...
  const handleShare = () => {
    if (!summary) {
      alert("Please generate a summary first before sharing");
      return;
    }
    // Create a text blob for sharing
    const blob = new Blob([summary], { type: "text/plain" });
    const file = new File([blob], "summary.txt", { type: "text/plain" });
  ...
  return (
    <div>
      ...
      <ShareModal
        ...
        fileBlob={new Blob([summary], { type: "text/plain" })}
