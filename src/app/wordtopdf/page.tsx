...
export default function DocToPdfPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      const response = await fetch("/api/wordtopdf", {  // Correct API endpoint
        method: "POST",
        body: formData,
      });
      ...
      a.href = url;
      a.download = "converted.pdf"; // The downloaded file will be named 'converted.pdf'
      a.click();
      ...
      <div style={{ maxWidth: "900px", margin: "4rem auto", padding: "0 2rem" }}>
        ...
        >
          ...
          <p style={{ marginTop: "1rem", marginBottom: "1rem" }}>
            Drag and drop a DOC/DOCX file here
          </p>
          <label
            htmlFor="fileInput"
            style={{
        ...
        <div style={{ marginTop: "3rem" }}>
          <p style={{ marginBottom: "1rem", fontSize: "0.95rem" }}>
            Easily convert DOC, DOCX, and other documents into PDF in just a few clicks!
          </p>
        </div>
