...
export default function ScanToPdfPage() {
  ...
  const instructionData = toolData["scan-to-pdf"] || toolData["scan-to-pdf"]; // Use appropriate key
  ...
  const handleUrlSubmit = async () => {
    ...
    try {
      ...
      if (blob.type !== "image/jpeg" && blob.type !== "image/jpg") {
        alert("URL must point to a JPG/JPEG image file");
        return;
      }
  ...
  const handleConvert = async () => {
    if (files.length === 0) {
      setError("Please upload at least one scanned JPG file.");
      return;
    }
  ...
  const handleShare = () => {
    if (!convertedBlob) {
      alert("Please convert the images to PDF first before sharing");
      return;
    }
        ...
        <div style={{ flex: 1, maxWidth: "900px", margin: "0 auto" }}>
                    ...
                    <>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          padding: "0.5rem 1rem",
                          borderRadius: "6px",
                          cursor: !convertedBlobUrl ? "not-allowed" : "pointer",
                          display: "flex",
                          alignItems: "center",
                          gap: "0.5rem",
                          fontSize: "0.85rem",
                          fontWeight: "500",
                          opacity: !convertedBlobUrl ? 0.5 : 1
                        }}
                      >
                        <TbShare3 />
                        Share
          ...
          <div style={{ marginTop: "3rem", fontFamily: 'Georgia, "Times New Roman", serif' }}>
            <p style={{ marginBottom: "1rem", fontSize: "0.95rem", color: "#555" }}>
              Turn your scanned JPG documents into a single, high-quality PDF file.
            </p>
            <ul style={{ listStyleType: "none", fontSize: "0.95rem", padding: 0, margin: 0 }}>
              {[
                "Upload multiple scanned JPG images",
          ...
          >
            ...
            <p style={{ marginTop: "0.5rem", color: "#555" }}>
              Your scanned files are encrypted during upload and automatically deleted after 2 hours. No storage. No tracking.
            </p>
            <div
              style={{
                marginTop: "1rem",
