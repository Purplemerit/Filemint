...
export default function PdfToPptPage() {
  ...
  const instructionData = toolData["pdf-to-ppt"];
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = `converted_${file?.name?.replace(/\.[^/.]+$/, "") || "document"}.pptx`;
  ...
  const handleConvert = async () => {
    ...
    try {
      const res = await fetch("/api/pdftoppt", {
        method: "POST",
        body: formData,
      });
        ...
        <div style={{ flex: 1, maxWidth: "900px", margin: "0 auto" }}>
            ...
            {isConverted ? (
              ...
              <div style={{
                ...
                <p style={{ color: "#666", textAlign: "center", maxWidth: "400px" }}>
                  Your PDF has been converted to PowerPoint. Download your file below.
                </p>
          ...
          <div style={{ marginTop: "3rem", fontFamily: 'Georgia, "Times New Roman", serif' }}>
            <p style={{ marginBottom: "1rem", fontSize: "0.95rem", color: "#555" }}>
              Convert your PDF files to editable PowerPoint presentations with our seamless online tool.
            </p>
            <ul style={{ listStyleType: "none", fontSize: "0.95rem", padding: 0, margin: 0 }}>
              {[
                "Perfect for creating and editing presentations",
