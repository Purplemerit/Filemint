      ...
      <div style={{ maxWidth: "900px", margin: "4rem auto", padding: "0 2rem" }}>
        ...
        <div style={{ marginTop: "3rem" }}>
          <p style={{ marginBottom: "1rem", fontSize: "0.95rem" }}>
            Easily convert your HTML files into high-quality PDFs.
          </p>
        </div>
        ...
        >
          ...
          <p style={{ marginTop: "0.5rem" }}>
            Your HTML files are encrypted during upload and automatically deleted after 2 hours. No tracking. No storage. Full privacy.
          </p>
        </div>
      </div>
    </div>
